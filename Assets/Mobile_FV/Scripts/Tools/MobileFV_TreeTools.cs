...
public class MobileFV_TreeTools : EditorWindow
{
    ...
    public static void ShowWindow()
    {
        ...
        EditorWindow editorWindow = EditorWindow.GetWindow(typeof(MobileFV_TreeTools));
